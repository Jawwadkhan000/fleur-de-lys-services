...
function Certify() {
  return (
    <section className="relative overflow-hidden bg-[#0f0f0f] py-20 text-white">

      {/* Background Glow */}
      <div className="absolute left-[-120px] top-10 h-72 w-72 rounded-full bg-gray-300/10 blur-3xl"></div>
      <div className="absolute right-[-100px] bottom-0 h-72 w-72 rounded-full bg-white/5 blur-3xl"></div>

      <div className="relative mx-auto max-w-7xl px-6">

        {/* Main Card */}
        <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-br from-[#161616] via-[#121212] to-[#1a1a1a] p-8 md:p-12">

          {/* Small Blur Accent */}
          <div className="absolute top-0 right-0 h-60 w-60 bg-green-500/10 blur-3xl"></div>

          {/* Top Content */}
          <div className="relative z-10 mb-14 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          {/* Bottom Bar */}
          <div className="relative z-10 mt-8 flex flex-col gap-4 rounded-2xl border border-white/10 bg-black/20 px-6 py-5 md:flex-row md:items-center md:justify-between">
